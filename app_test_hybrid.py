...
#                                 if last_check_time < datetime.datetime.now() - datetime.timedelta(seconds = 30):
#                                     last_check_time = datetime.datetime.now()
#                                     print("check  min..........................\n\n\n\n\n\n")

                                
#                             else:
#                                 retention_period = datetime.datetime.utcnow() - datetime.timedelta(minutes=2)
#                                 if last_check_time < datetime.datetime.now() - datetime.timedelta(seconds = 1):
#                                     last_check_time = datetime.datetime.now()
