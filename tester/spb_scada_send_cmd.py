...
_config_spb_group_name = os.environ.get("SPB_GROUP", "wzero_tst")
_config_spb_eon_name = os.environ.get("SPB_EON", "rpi")
_config_spb_device_name = os.environ.get("SPB_DEVICE", "Multispan")
