...
_config_spb_eon_name = os.environ.get("SPB_EON", "rpi1")
_config_spb_device_name = os.environ.get("SPB_DEVICE", "plc")

# MQTT Configuration
_config_mqtt_host = os.environ.get("MQTT_HOST", "172.105.49.231")
...
# scada.publish_command_device(_config_spb_eon_name, _config_spb_device_name, {"vpn_start": True})
scada.publish_command_device(_config_spb_eon_name, _config_spb_device_name, {"vpn_stop": True})
